var ctrContaContabil = (function () {
    ...
    var _create = function () {
        ...
        _confirmDeleteContaContabil = ConfirmDelete();
        _confirmDeleteContaContabil.create("divConfirm", "ContaContabil");
    }
    ...
    var _confirm = function (id) {
        ...
        for (var i = 0; i < _datasource.length; i++) {
            if (_datasource[i].CodContaContabil === id) {
                _confirmDeleteContaContabil.setMessage(_datasource[i].Descricao);
            }
        }
        _confirmDeleteContaContabil.show();
        _resetValidation.call(this);
    }
    ...
    var _removeAt = function () {
        ...
        _search(_txtBusca.value);
        _confirmDeleteContaContabil.hide();
        _resetValidation.call(this);
    }
    ...
    function _paginacao(total) {
        ...
        if (totalPages > 1) {
            ...
            if (_indexPage > limitButtons) {
                ...
                li.innerHTML = "<a href='#' onClick='ctrContaContabil.SetPage(" + (_indexPage - 1) + ");return false;'>&laquo;</a>";
                _pagination.appendChild(li);
            }

            for (i = start; i <= lastButton; i++) {
                var li = window.document.createElement("li");
                li.innerHTML = "<a href='#' onClick='ctrContaContabil.SetPage(" + i + ");return false;'>" + i + "</a>";
            ...
            if (totalPages > lastButton) {
                if (_indexPage < totalPages) {
                    var li = window.document.createElement("li");
                    li.innerHTML = "<a href='#' onClick='ctrContaContabil.SetPage(" + (_indexPage + 1) + ");return false;'>&raquo;</a>";
                    _pagination.appendChild(li);
                }
            }
