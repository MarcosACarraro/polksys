var ctrContaReceber = (function () {
    ...
    var _tableDataBind = function () {
        ...
        for (var i = 0; i < _datasource.length; i++) {
            ...
            cell5.innerHTML = "<a href='#' onClick='ctrContaReceber.baixarEdit(" + _datasource[i].CodContaLancamento + ");return false;'><span class='glyphicon glyphicon-edit'></span></a></div>";
            cell6.innerHTML = "<a href='#' onClick='ctrContaReceber.editAt(" + _datasource[i].CodContaLancamento + ");return false;'><span class='glyphicon glyphicon-edit'></span></a></div>";
            cell7.innerHTML = "<a href='#' onClick='ctrContaReceber.confirm(" + _datasource[i].CodContaLancamento + ");return false;'><span class='glyphicon glyphicon-trash'></span></a></div>";
        }
    }
    ...
    var _baixarEdit = function (id) {
        ...
        ctrContaReceberBaixa.create(id,valor);
    ...
    function _paginacao(total) {
        ...
        if (totalPages > 1) {
            ...
            if (_indexPage > limitButtons) {
                ...
                li.innerHTML = "<a href='#' onClick='ctrContaReceber.SetPage(" + (_indexPage - 1) + ");return false;'>&laquo;</a>";
                _pagination.appendChild(li);
            }

            for (i = start; i <= lastButton; i++) {
                var li = window.document.createElement("li");
                li.innerHTML = "<a href='#' onClick='ctrContaReceber.SetPage(" + i + ");return false;'>" + i + "</a>";
            ...
            if (totalPages > lastButton) {
                if (_indexPage < totalPages) {
                    var li = window.document.createElement("li");
                    li.innerHTML = "<a href='#' onClick='ctrContaReceber.SetPage(" + (_indexPage + 1) + ");return false;'>&raquo;</a>";
                    _pagination.appendChild(li);
                }
            }
